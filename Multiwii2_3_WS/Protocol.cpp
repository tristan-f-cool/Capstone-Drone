...
#define MSP_SET_POS_GAINS        215   //in message          Set the position controller PID gains       
...
void evaluateCommand() {
  ...
  switch (cmdMSP[CURRENTPORT]) {
    ...
    case MSP_EEPROM_WRITE:
      ...
      break;
    case MSP_DEBUG:
      s_struct((uint8_t*)&debug, 8);//MDP - this should eventually be changed to 10
      break;
#ifdef DEBUGMSG
    case MSP_DEBUGMSG: //MDP - We have another case that is 253, change this number w/ Davin
      {
